...
export const portfolioConfig: IPortfolioConfig = {
  work: [
    ...
    },
    {
      ...
      title: 'Software Engineer',
      description:
        'Development and maintenance of microservices for real-time processing, aggregation, and analytics of financial transactions.',
      technologies: [
        'Java',
        'Python',
        'SLANG',
  ...
  projects: [
    {
      ...
      description:
        'Interactive generator of radial gradient with Gaussian distribution stops and dither simulating mask for reducing visual banding.',
      link: 'https://github.com/kkuchar2/smooth-gradient',
      websiteLink: 'https://smooth-gradient.kkucharski.com/',
      technologies: ['Vercel', 'NextJS', 'React', 'TS', 'Sass Modules', 'shadcn/ui'],
    },
    {
      title: 'sorting visualiser',
      description:
        'Interactive visualisation of sorting algorithm using ThreeJS Fiber and service workers. Changes in sorted data are shown with red marker and synthesized sound.',
    ...
    },
    {
      title: 'emcia.design',
      description:
        'UI/UX Designer’s portfolio website showcasing client work, with access to resume and possibility of direct mail contact from site with Mailgun.' +
    ...
    },
    {
      title: 'openglengine',
      description:
        'Hobby project as integration of OpenGL rendering system into graphical user interface. Used for testing, learning and experimentation.',
    ...
    },
    {
      title: 'libmpeg7',
      description:
        'Engineers Degree. Implementation of MPEG-7 standard to calculate descriptors of color, shape & structure patterns in digital images. Supplemented with JNI Java interface and Python bindings.',
